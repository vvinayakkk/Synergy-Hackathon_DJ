...
const Footer = () =>{
    return (
        <div className="mt-10 bg-gray-800 px-6 py-8">
        <div className="flex mb-8">
          <div className="w-1/4">
            <div className="flex items-center mb-4">
              ...
              <div>
                <div className="font-bold text-lg flex items-center">
                  multibagg.ai
                  <span className="ml-2 bg-gray-700 text-xs px-2 py-0.5 rounded">Beta</span>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500">Prices might be delayed by a few minutes.</p>
          </div>
          ...
          <div className="w-3/4 flex justify-between pl-20">
            ...
            <div>
              <h3 className="font-bold mb-4">Utility</h3>
              <ul className="space-y-3 text-sm text-gray-400">
                <li>Market</li>
                <li>Pricing</li>
                <li>Calculators</li>
            ...
            <div>
              ...
              <button className="bg-green-500 text-white rounded-md py-2 px-4 flex items-center">
              ...
              <button className="mt-3 bg-blue-500 text-white rounded-md py-2 px-4 flex items-center">
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="pt-6 mt-6 border-t border-gray-700 flex justify-between items-center">
          <div className="text-sm text-gray-500">© 2023 Multibagg. All rights reserved.</div>
